...
export function Toolbox({
  ...
  return (
    <div className="toolbox" role="toolbar" aria-label="Slide tools">
      ...
      {exportOpen && (
        <div className="export-menu" role="menu" aria-label="Export">
          <button role="menuitem" onClick={() => onExport("pdf")} disabled={exporting}>
            PDF
          </button>
          <button role="menuitem" onClick={() => onExport("pptx")} disabled={exporting}>
            PowerPoint (.pptx)
          </button>
        </div>
      )}
